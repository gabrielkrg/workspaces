...
<template>
  <div class="flex items-center justify-between">
    <div class="flex flex-1 items-center space-x-2">
      ...
      <DataTableFacetedFilter v-if="table.getColumn('done')" :column="table.getColumn('done')" title="Status"
        :options="statuses" />
      <DataTableFacetedFilter v-if="table.getColumn('repeat')" :column="table.getColumn('repeat')" title="Repeat"
        :options="repeats" />
