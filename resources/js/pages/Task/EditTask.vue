...
watch(() => props.task, (newTask) => {
    if (newTask) {
        ...
        form.repeat = newTask.repeat;
        form.tags = newTask.tags?.map((tag: any) => tag.name) || [];
        form.description = newTask.description;
        form.delete_after = newTask.delete_after;
        form.client_id = newTask.client_id;
    }
}, { immediate: true });
            ...
            <form @submit.prevent="submit">
                ...
                <div class="grid gap-4 p-4">
                    ...
                    <div class="grid grid-cols-4 items-center gap-4">
                        ...
                        <Textarea id="description" v-model="form.description" class="col-span-4" />
                    </div>

                    <div class="items-top flex gap-x-2">
                        <Checkbox id="delete_after" v-model="form.delete_after" />
